			...
			$obj['state'] = $state;
			 $userid =  $_SESSION["user"] ;
			     ...
			     $filename = $_FILES['upload']['name'];
		 	     ...
		 	     $fname = "/home/benoist/data/images/" . $userid . ".img";
				 
  			     system("cp " . $filename . " "  . $fname);
...
//			     print($filename);
		 	 ...
		 	 $fname = "/home/benoist/data/profiles/" . $userid . ".json";
			 $fp = fopen($fname, 'w');
		...
		$fname = "/home/benoist/data/profiles/" . $userid . ".json";
	  	if (file_exists($fname))  {
		    $profile = json_decode(file_get_contents($fname));
		}   else {
		    //$profile = "File not found";
		}
		$this->loadView( "users/edit_profile");
